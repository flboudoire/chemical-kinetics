...
.. math:: \frac{d[D]}{dt} = k_{H\textbf{1}}[HMF] + k_{H\textbf{2}1}[DFF] + k_{H\textbf{2}2}[HMFCA]
.. math:: + k_{H\textbf{3}}[FFCA] + k_{H\textbf{4}}[FDCA] - k_{H^*}[D]

.. math:: \frac{d[D^*]}{dt} = k_{H^*}[D]
...
.. math::  [humins] = [D\_HMF] + [D\_DFF] + [D\_HMFCA] + [D\_FFCA] + [D\_FDCA] 

.. math::  [humins^*] = [Dx\_HMF] + [Dx\_DFF] + [Dx\_HMFCA] + [Dx\_FFCA] + [Dx\_FDCA] 

Therefore, the derivatives presented above for the concentration of humins are rewritten in the following way:

.. math:: \frac{d[D\_HMF]}{dt} = k_{D\textbf{1}}[HMF] - k_{D^*}[D\_HMF]

.. math:: \frac{d[D\_DFF]}{dt} = k_{D\textbf{1}}[DFF] - k_{D^*}[D\_DFF]

.. math:: \frac{d[D\_HMFCA]}{dt} = k_{D\textbf{1}}[HMFCA] - k_{D^*}[D\_HMFCA]

.. math:: \frac{d[D\_FFCA]}{dt} = k_{D\textbf{1}}[FFCA] - k_{D^*}[D\_FFCA]

.. math:: \frac{d[D\_FDCA]}{dt} = k_{D\textbf{1}}[FDCA] - k_{D^*}[D\_FDCA]

The derivatives for the concentration of D\* are rewritten in this way:

.. math:: \frac{d[Dx\_HMF]}{dt} = k_{D^*}[D\_HMF]

.. math:: \frac{d[Dx\_DFF]}{dt} = k_{D^*}[D\_DFF]

.. math:: \frac{d[Dx\_HMFCA]}{dt} = k_{D^*}[D\_HMFCA]

.. math:: \frac{d[Dx\_FFCA]}{dt} = k_{D^*}[D\_FFCA]

.. math:: \frac{d[Dx\_FDCA]}{dt} = k_{D^*}[D\_FDCA]
